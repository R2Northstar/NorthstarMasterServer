...
const { STRYDER_RESPONSE, NO_AUTH_RESPONSE, UNAUTHORIZED_GAME, UNAUTHORIZED_PWD, PLAYER_NOT_FOUND, INVALID_MASTERSERVER_TOKEN, JSON_PARSE_ERROR } = require( "../shared/errorcodes" )
...
module.exports = ( fastify, opts, done ) =>
{
	...
	fastify.post( "/client/auth_with_server",
		...
		async ( request ) =>
		{
			...
			if ( !authResponse )
				return { success: false, error: NO_AUTH_RESPONSE }
