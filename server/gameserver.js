...
async function SharedTryAddServer( request )
{
	...
	let newServer = new GameServer( name, description, playerCount, request.query.maxPlayers, request.query.map, request.query.playlist, request.ip, request.query.port, request.query.authPort, request.query.password, registeredTo, modInfo )
