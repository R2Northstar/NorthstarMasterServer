...
const { GameServer, GetGameServers, AddGameServer, RemoveGameServer, GetGhostServer, HasGhostServer, RemoveGhostServer } = require( path.join( __dirname, "../shared/gameserver.js" ) )
